 ...
 * @author Charkaz
 */
public class musteriler extends javax.swing.JInternalFrame {
    String deyer;
    int id=0;
Insan insan = new Insan();
    ...
    public musteriler() throws SQLException {
        initComponents();
        get.getMusteriler(jTable1,jTextField1.getText());
    ...
    private void initComponents() {
        ...
        jDialog1.setMinimumSize(new java.awt.Dimension(416, 471));
        ...
        jLabel10.setText("id - li müştərini silməyə əminsiniz ?");
        ...
        setMaximizable(true);
        setResizable(true);
        setMinimumSize(new java.awt.Dimension(739, 484));
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/musteriIcon/musteriler.png"))); // NOI18N
    ...
    private void jTextField1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField1ActionPerformed
        try {
            get.getMusteriler(jTable1,jTextField1.getText());        // TODO add your handling code here:
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      try{
         ...
         if(insan.musteriQeyd(jTextField2.getText(), jTextField3.getText(), jTextField4.getText(), jTextField5.getText(), Dtarix)){
...
jDialog2.show();        // TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            insan.musteriSil(Integer.valueOf(deyer));
 ...
 try{
         ...
         if(insan.musteriUpdate(id,jTextField6.getText(), jTextField7.getText(), jTextField8.getText(), jTextField9.getText(), Dtarix)){
